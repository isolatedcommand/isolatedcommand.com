---
description: "Isolated Command is a youth-led team turning curiosity into real projects — cybersecurity, hackathons, CTFs, and community-built e-services. Curiosity starts here."
############################### Banner ##############################
banner:
  enable: true
  bg_image: ""
...
funfacts:
  enable: true
  title: "Our Timeline"
  description: "A summary of what we have achieved thus far as a team and individually!"
  funfact_item:
  # funfacts item loop
  ...
  # funfacts item loop
  - icon: "fas fa-newspaper" #https://fontawesome.com/v5.15/icons
    name: "Total Research / Publications"
    count: "9"

  # funfacts item loop
  - icon: "fas fa-crosshairs" #https://fontawesome.com/v5.15/icons
    name: "Total Hackathon / CTF Participated"
    count: "2"
